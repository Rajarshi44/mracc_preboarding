      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50 flex items-center justify-center">
        <Card className="max-w-md border-0 shadow-xl bg-white/80 backdrop-blur-sm">
          <CardHeader className="text-center pb-4">
            ...
            <CardTitle className="text-xl font-semibold text-gray-900">Application Not Found</CardTitle>
            <CardDescription className="text-gray-600">
              We couldn't find your preboarding information. Please submit the form again.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Link href="/preboard">
        ...
        <div className="max-w-4xl mx-auto px-6 py-4">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Track your preboarding progress</p>
            </div>
          </div>
        </div>
      </header>
        ...
        <div className="space-y-8">
          ...
          <Card className="border-0 shadow-2xl bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white overflow-hidden relative">
            ...
            <CardHeader className="relative">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <CardTitle className="text-white text-xl font-semibold">Temporary Employee ID</CardTitle>
                    <CardDescription className="text-gray-300">Valid until official ID is issued</CardDescription>
                  </div>
                </div>
                <Button
                  variant="secondary"
            ...
            <CardContent className="relative">
              <div className="text-3xl font-mono font-bold mb-3 tracking-wider">{employeeData.tempId}</div>
          ...
          <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm">
            ...
            <CardContent>
              <div className="flex items-center justify-between mb-8">
                <Badge
                  className={`${getStatusColor(employeeData.status)} border px-4 py-2 text-sm font-medium rounded-xl`}
                >
                ...
                <span className="text-sm text-gray-500 bg-gray-50 px-3 py-1 rounded-lg">
                  Submitted: {new Date(employeeData.submittedAt).toLocaleDateString()}
                </span>
              </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-yellow-700 leading-relaxed">
                        Your application is currently being reviewed by our HR team. You'll receive an email
                        notification once the review is complete. This process typically takes 1-2 business days.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              {employeeData.status === "approved" && (
                <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-xl p-6">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-green-800 mb-2">Application Approved!</h4>
                      <p className="text-green-700 leading-relaxed">
                        Congratulations! Your preboarding application has been approved. Your official employee ID will
                        be ready on your start date. Welcome to the TechCorp team!
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm">
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center space-x-3 p-3 bg-gray-50/50 rounded-lg">
                  ...
                  <span className="text-sm text-gray-700 font-medium">{employeeData.email}</span>
                </div>
                <div className="flex items-center space-x-3 p-3 bg-gray-50/50 rounded-lg">
                  <Phone className="w-5 h-5 text-gray-400" />
                  <span className="text-sm text-gray-700 font-medium">{employeeData.phone}</span>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm">
              <CardHeader className="pb-6">
                <CardTitle className="text-lg font-semibold text-gray-900">Process Timeline</CardTitle>
              </CardHeader>
              <CardContent>
                <ul className="space-y-4">
                  <li className="flex items-center space-x-3 p-3 bg-green-50/50 rounded-lg">
                    <CheckCircle className="w-5 h-5 text-green-500" />
                    <span className="text-sm text-gray-700 font-medium">Application submitted</span>
                  </li>
                  <li className="flex items-center space-x-3 p-3 bg-yellow-50/50 rounded-lg">
                    <Clock className="w-5 h-5 text-yellow-500" />
                    <span className="text-sm text-gray-700 font-medium">HR review in progress</span>
                  </li>
                  <li className="flex items-center space-x-3 p-3 bg-gray-50/50 rounded-lg">
                    <Clock className="w-5 h-5 text-gray-400" />
                    <span className="text-sm text-gray-500">Official ID issuance</span>
                  </li>
                  <li className="flex items-center space-x-3 p-3 bg-gray-50/50 rounded-lg">
                    <Clock className="w-5 h-5 text-gray-400" />
                    <span className="text-sm text-gray-500">First day orientation</span>
                  </li>
                </ul>
              </CardContent>
            </Card>
          ...
          <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm">
            <CardHeader className="pb-6">
              <CardTitle className="text-lg font-semibold text-gray-900">Need Assistance?</CardTitle>
              <CardDescription className="text-gray-600">
                Our HR team is here to help with any questions about your application status.
              </CardDescription>
            </CardHeader>
            <CardContent>
